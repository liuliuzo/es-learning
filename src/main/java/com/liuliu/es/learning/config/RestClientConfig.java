 ...
 */
@Configuration
public class RestClientConfig extends ElasticsearchConfigurationSupport {
    ...
    public RestClients.ElasticsearchRestClient elasticsearchRestClient() {
        ...
        ClientConfiguration clientConfiguration = ClientConfiguration.builder()
                ...
                .withSocketTimeout(Duration.ofMillis(100000))
                .build();
    ...
    public ElasticsearchOperations elasticsearchOperations() {
        return new ElasticsearchRestTemplate(elasticsearchRestClient().rest(), elasticsearchConverter(), resultsMapper());
    }
